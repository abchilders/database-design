...
/* NOTE: I couldn't figure out how to convey a start time and end time via 
   ...
   This is opposed to date_enrolled, which is the day that the owner
...
(pet_id			integer, 
 ...
 start_time		integer,
 end_time		integer,
 primary key (pet_id, section_id, date_of_daycare), 
 foreign key (section_id) references doggy_daycare); 

/* A problem with this primary key: It assumes that a pet is only 
   enrolled in one daycare session a day. To fix this, maybe
   I should create a sequence to generate unique enrollment 
   numbers for all my enrollment association entities.
*/
