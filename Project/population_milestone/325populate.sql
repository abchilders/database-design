...
values
(300000, 'Veterinarian', 3461.50); 

insert into employee
values
(300002, 'Groomer', 1538.50); 
...
insert into employee
values
(300010, 'Veterinarian', 3460);

insert into employee
values
(300012, 'Animal Care Associate', 1155); 

insert into employee
values
(300014, 'Animal Care Associate', 1154); 

insert into employee
values
(300016, 'Animal Care Associate', 1153.50);

insert into employee
values
(300018, 'Animal Care Associate', 1154.50); 
...
values
(11, 'C10008', '23-NOV-2018', 100003); 

insert into class_enrollment
values
(12, 'C10015', '01-NOV-2018', 100009);

insert into class_enrollment
values
(13, 'C10008', '12-NOV-2018', 100012);

insert into class_enrollment
values
(14, 'C10015', '18-NOV-2018', 100018);

insert into class_enrollment
values
(15, 'C10013', '04-NOV-2018', 100021);

insert into class_enrollment
values
(16, 'C10017', '09-NOV-2018', 100024);

insert into class_enrollment
values
(17, 'C10013', '15-NOV-2018', 100027);

insert into class_enrollment (owner_id, section_id, date_enrolled)
values
(18, 'C10014', '19-NOV-2018');

insert into class_enrollment
values
(19, 'C10009', '23-NOV-2018', 100033);

insert into class_enrollment (owner_id, section_id)
values
(20, 'C10014'); 
...
values
(100003, 'B10000', '19-NOV-2018', '23-DEC-2018', '31-DEC-2018');

insert into boarding_enrollment
values
(100006, 'B10002', '19-NOV-2018', '14-DEC-2018', '18-DEC-2018'); 

insert into boarding_enrollment
values
(100012, 'B10003', '28-NOV-2018', '27-DEC-2018', '02-JAN-2019');

insert into boarding_enrollment
values
(100015, 'B10001', '11-NOV-2018', '09-DEC-2018', '13-DEC-2018');

insert into boarding_enrollment
values
(100021, 'B10003', '02-NOV-2018', '28-DEC-2018', '30-DEC-2018');

insert into boarding_enrollment
values
(100033, 'B10000', '30-NOV-2018', '02-JAN-2019', '09-JAN-2019');

insert into boarding_enrollment
values
(100039, 'B10001', '29-NOV-2018', '10-DEC-2018', '13-DEC-2018');

insert into boarding_enrollment (pet_id, section_id, start_date, end_date)
values
(100042, 'B10000', '08-DEC-2018', '11-DEC-2018'); 

insert into boarding_enrollment (pet_id, section_id, start_date, end_date)
values
(100051, 'B10001', '19-DEC-2018', '22-DEC-2018'); 
...
values 
(100054, 'D10004', '10-NOV-2018', '27-DEC-2018', 0830, 1700);

insert into daycare_enrollment
values
(100054, 'D10004', '11-NOV-2018', '27-DEC-2018', 0830, 1700);

insert into daycare_enrollment
values
(100054, 'D10004', '12-NOV-2018', '27-DEC-2018', 0830, 1700);

insert into daycare_enrollment
values
(100054, 'D10004', '13-NOV-2018', '27-DEC-2018', 0830, 1700);

insert into daycare_enrollment
values
(100039, 'D10005', '15-DEC-2018', '01-DEC-2018', 0900, 1330);

insert into daycare_enrollment
values
(100039, 'D10005', '16-DEC-2018', '01-DEC-2018', 0900, 1330);

insert into daycare_enrollment
values
(100039, 'D10005', '17-DEC-2018', '01-DEC-2018', 1000, 1500); 

insert into daycare_enrollment(pet_id, section_id, date_of_daycare, start_time, end_time)
values
(100012, 'D10007', '13-DEC-2018', 1000, 1400);

insert into daycare_enrollment(pet_id, section_id, date_of_daycare, start_time, end_time)
values
(100012, 'D10007', '14-DEC-2018', 1000, 1600);

insert into daycare_enrollment(pet_id, section_id, date_of_daycare, start_time, end_time)
values
(100012, 'D10007', '16-DEC-2018', 0900, 1700);
