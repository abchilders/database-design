...
insert into employee
values
(300002, 'Groomer', 1538.50, '12-FEB-2009'); 

insert into employee
values
(300004, 'Groomer', 160, '20-MAR-2010'); 
...
insert into employee
values
(300008, 'Teacher', 1540, '01-MAY-2012');

insert into employee
values
(300010, 'Veterinarian', 3460, '27-JUN-2013');

insert into employee
values
(300012, 'Animal Care Associate', 1155, '16-JUL-2014'); 

insert into employee
values
(300014, 'Animal Care Associate', 1154, '30-AUG-2015'); 

insert into employee
values
(300016, 'Animal Care Associate', 1153.50, '11-SEP-2016');

insert into employee
values
(300018, 'Animal Care Associate', 1154.50, '20-OCT-2017'); 
